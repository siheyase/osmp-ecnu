      ...
      <div class="tab-container" style="width: 50%;">
        <a-tabs v-model:activeKey="activeKey1">
          ...
          <a-tab-pane key="2">
            ...
            <BarChart :chartData="NodeDetail.taskRecord" :optionConfig="nodeSynTask?.chartConfig"
        ...
        <div style="width: 95%; margin: 0 auto;">
          <a-tabs v-model:activeKey="activeKey2">
            <a-tab-pane key="1">
              ...
              <PieChart :chartData="NodeDetail.storageDistribution" :optionConfig="nodeStorage?.chartConfig"
            ...
            <a-tab-pane key="2">
              ...
              <PieChart :chartData="NodeDetail.statusDistribution" :optionConfig="nodeStatusData?.chartConfig"
